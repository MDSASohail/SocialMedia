...
function Share() {
  ...
  const handleSubmit=async(e)=>{
       ...
       if(file)
       {
          ...
          try {
                     const imgName= await  axios.post('https://rest-api-gules.vercel.app/upload', data, {
  headers: {
...
console.log("Image name is generated by "+imgName.data.img)
newPost.img=`Images/${imgName.data.img}` //pussing the name of img in the post section
console.log("New Post data is "+JSON.stringify(newPost))
await axios.post('https://rest-api-gules.vercel.app/post/',newPost);
  ...
  return (
    <>
      <form className="p-4 m-4 share-Div" onSubmit={(e)=>{handleSubmit(e)}}>
        <div className="flex ">
          <img className="w-12 h-12 mr-3 rounded-full" src={user.profile?"https://rest-api-gules.vercel.app/"+user.profile:img} alt="" />
          <input
