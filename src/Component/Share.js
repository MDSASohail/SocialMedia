...
function Share() {
  ...
  const handleSubmit=async(e)=>{
       ...
       if(file)
       {
          ...
          try {
                     const imgName= await  axios.post('http://localhost:8000/upload', data, {
  headers: {
  ...
  return (
    <>
      <form className="p-4 m-4 share-Div" onSubmit={(e)=>{handleSubmit(e)}}>
        <div className="flex ">
          <img className="w-12 h-12 mr-3 rounded-full" src={user.profile?"http://localhost:8000/"+user.profile:img} alt="" />
          <input
